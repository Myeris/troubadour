export enum Constant {
  HighscoreSaveSuccess = 'Your highscore has been saved.',

  PracticeSessionDeleteSuccess = 'Your practice session has been removed.',
  PracticeSessionCreateSuccess = 'Your practice session has been created.',
